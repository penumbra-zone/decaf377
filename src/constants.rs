...
pub static M: Lazy<BigInteger256> = Lazy::new(|| {
    ark_ff::MontFp!("60001509534603559531609739528203892656505753216962260608619555").into()
});
...
pub static M_MINUS_ONE_DIV_TWO: Lazy<BigInteger256> = Lazy::new(|| {
    ark_ff::MontFp!("30000754767301779765804869764101946328252876608481130304309777").into()
});
