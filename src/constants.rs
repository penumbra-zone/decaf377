...
// ZETA**((M+1)/2) = 1167730709215322832920115255905223110522057496921131689416369926781104252021
pub static ZETA_TO_M_PLUS_ONE_DIV_TWO: Lazy<Fq> = Lazy::new(|| {
    ark_ff::field_new!(
        Fq,
        "1167730709215322832920115255905223110522057496921131689416369926781104252021"
    )
});
